...
export const USERS: User[] = [
  {
    ...
    name: 'André Brito',
    password: '1008',
    avatarDesc: 'Disney style 3D character, tall black man with a beard and glasses, wearing a brown fedora hat, a leopard print short-sleeved button-up shirt, short light beige shorts (above the knee), smiling, extremely lean, very fit, athletic build, slim waist, defined muscles, standing on a sunny street with colorful buildings and mountains in the background, high quality, 3d render.',
